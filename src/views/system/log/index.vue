        ...
        <el-container>
          <el-header>
            <div class="left-panel">
              <el-date-picker @change="timeChange" v-model="date" format="YYYY-MM-DD HH:mm:ss" type="datetimerange"
          ...
          <el-main class="nopadding">
            <scTable ref="table" :apiObj="apiObj" :params="{start_time:date[0],end_time:date[1]}" stripe
              ...
              <el-table-column label="请求时间" prop="create_time" width="170">
                <template #default="{row,$index}">
                  {{ $TOOL.dateFormat(row.create_time) }}
                </template>
              </el-table-column>
            </scTable>
          </el-main>
